...
type MempoolIter struct {
	...
	//	*MempoolIter_Mpcli
	Client isMempoolIter_Client `protobuf_oneof:"client"`
}
...
type isMempoolIter_Client interface {
	isMempoolIter_Client()
	MarshalTo([]byte) (int, error)
	Size() int
}

type MempoolIter_Mpcli struct {
	Mpcli *mempool.LocalClient `protobuf:"bytes,1,opt,name=mpcli,proto3,oneof" json:"mpcli,omitempty"`
}

func (*MempoolIter_Mpcli) isMempoolIter_Client() {}

func (m *MempoolIter) GetClient() isMempoolIter_Client {
	if m != nil {
		return m.Client
	}
	return nil
...
func (m *MempoolIter) GetMpcli() *mempool.LocalClient {
	if x, ok := m.GetClient().(*MempoolIter_Mpcli); ok {
		return x.Mpcli
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*MempoolIter) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*MempoolIter_Mpcli)(nil),
	}
}
...
var fileDescriptor_e415c24393570900 = []byte{
	...
	0xd2, 0x52, 0xd9, 0x15, 0x7b, 0xb5, 0xdc, 0x1d, 0x02, 0x1b, 0x01, 0xbb, 0x6b, 0xec, 0x80, 0x22,
	...
	,
}
	...
	if m.Client != nil {
		{
			size := m.Client.Size()
			i -= size
			if _, err := m.Client.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *MempoolIter_Mpcli) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MempoolIter_Mpcli) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Mpcli != nil {
		{
			size, err := m.Mpcli.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MempoolIter_Mpcli) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MempoolIter) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Mpcli", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &mempool.LocalClient{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Client = &MempoolIter_Mpcli{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
