...
type MempoolClient struct {
	MemAddres string `protobuf:"bytes,1,opt,name=mem_addres,json=memAddres,proto3" json:"mem_addres,omitempty"`
}

func (m *MempoolClient) Reset()         { *m = MempoolClient{} }
func (m *MempoolClient) String() string { return proto.CompactTextString(m) }
func (*MempoolClient) ProtoMessage()    {}
func (*MempoolClient) Descriptor() ([]byte, []int) {
	return fileDescriptor_2af51926fdbcbc05, []int{5}
}
func (m *MempoolClient) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MempoolClient) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MempoolClient.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MempoolClient) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MempoolClient.Merge(m, src)
}
func (m *MempoolClient) XXX_Size() int {
	return m.Size()
}
func (m *MempoolClient) XXX_DiscardUnknown() {
	xxx_messageInfo_MempoolClient.DiscardUnknown(m)
}

var xxx_messageInfo_MempoolClient proto.InternalMessageInfo

func (m *MempoolClient) GetMemAddres() string {
	if m != nil {
		return m.MemAddres
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MempoolClient)(nil), "tendermint.mempool.MempoolClient")
}
...
var fileDescriptor_2af51926fdbcbc05 = []byte{
	...
	,
}
...
func (m *MempoolClient) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MempoolClient) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MempoolClient) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.MemAddres) > 0 {
		i -= len(m.MemAddres)
		copy(dAtA[i:], m.MemAddres)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.MemAddres)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MempoolClient) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MempoolClient) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MempoolClient: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MempoolClient: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MemAddres", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MemAddres = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
